...
def generate_prompts():
    return [
        ...
        ("Письмо после покупки с кросс-селлом",
         ...
         "сорт, предложи новый товар из рекомендаций {recommendations}, подчеркни скидку {discount} на следующий заказ,  "
         " также используй подходящие смайлики, завершай подписью команды с ссылками на соцсети"
         ),
        ("Активация неактивного клиента",
         ...
         "доказательства, также используй подходящие смайлики, и подпишись от лица команды."
         ),
        ("Рождество",
         ...
         "укажи срок действия акции - неделя после рождества, также используй подходящие смайлики, и подпишись от лица команды."
         ),
