...
def generate_prompts():
    return [
        ("День рождения",
         ...
         f"укажи срок действия акции - {deadline}, также используй подходящие смайлики. {css_guidelines}"
         ),
        ("Письмо после покупки с кросс-селлом",
         ...
         "скидку {discount} на следующий заказ, также используй подходящие смайлики. {css_guidelines}"
         ),
        ("Активация неактивного клиента",
         ...
         "добавь отзывы клиентов для социального доказательства, также используй подходящие смайлики. {css_guidelines}"
         ),
        ("Рождество",
