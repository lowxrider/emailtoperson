...
def generate_prompts():
    return [
        ("День рождения",
         ...
         "укажи срок действия акции - добавь неделю после дня рождения, также используй подходящие смайлики, "
         "закончи подписью команды с контактами"
         ),
        ("Письмо после покупки с кросс-селлом",
         ...
         "скидку {discount} на следующий заказ, также используй подходящие смайлики, завершай подписью команды с ссылками на соцсети"
         ),
        ("Активация неактивного клиента",
         ...
         "добавь отзывы клиентов для социального доказательства, также используй подходящие смайлики, и подпишись от лица команды."
         ),
        ("Рождество",
         ...
         "с Рождеством, рекомендует 3–4 сорта или наборы кофе с описанием вкусовых нот и способов приготовления, "
         "подчёркивает скидку {discount}, укажи срок действия акции - неделя после рождества, также используй подходящие "
         "смайлики, и подпишись от лица команды."
         ),
        ("Универсальный промпт",
         ...
         " а также тёплой подписью команды."
         ),
    ]
