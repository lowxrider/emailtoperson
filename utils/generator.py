...
def generate_prompts():
    return [
        ("День рождения",
         ...
         "персонализацию {first_name}; в теле (≤200 слов) начни с тёплого обращения {first_name}, "
        ...
        ("Активация неактивного клиента",
         ...
         "В теле письма (до 180 слов) поприветствуй {first_name} тёплым напоминанием о себе, представь подборку "
        ...
        ("Рождество",
         ...
         "где тело письма (до 200 слов) начинается с поздравления {first_name} с Рождеством, рекомендует 3–4 сорта или "
         "наборы кофе с описанием вкусовых нот и способов приготовления, подчёркивает скидку {discount}, "
         "указывает срок действия акции - неделя после рождества"
         ),
        ("Универсальный промпт",
         ...
         "предпочтения, и тело письма (до 200 слов) — с обращением по имени, упоминанием любимой обжарки и метода "
